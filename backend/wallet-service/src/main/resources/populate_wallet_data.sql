...
VALUES (
    ...
    'd8b5667d-f37c-4a15-9309-dc0b0ee50ef8', 
    'ACTIVE', 
    NOW(), 
    NOW()
...
VALUES (
    ...
    (SELECT id FROM wallet WHERE user_id = 'd8b5667d-f37c-4a15-9309-dc0b0ee50ef8'), 
    'EUR', 
    4694.60, 
    4694.60, 
    0, 
...
INSERT INTO wallet_transactions (
    ...
    (SELECT id FROM account WHERE wallet_id = (SELECT id FROM wallet WHERE user_id = 'd8b5667d-f37c-4a15-9309-dc0b0ee50ef8') AND currency = 'EUR'),
